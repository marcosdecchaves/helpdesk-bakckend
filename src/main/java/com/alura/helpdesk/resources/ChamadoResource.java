...
import com.alura.helpdesk.services.ChamadoService;
...
public class ChamadoResource {
	...
	{
		List<Chamado> listaChamados = chamadoService.findAll();
		
		List<ChamadoDTO> listaDTO = listaChamados.stream().map(obj -> new ChamadoDTO(obj)).collect(Collectors.toList());
